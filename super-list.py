...
if __name__ == "__main__":
    ...
    save_name_list = config["save_name"]
    angles_file_list = config["angle_file"]
    ...
    proj_path_list = config["proj_file"]


    for i, proj_path in enumerate(proj_path_list):
        angles = np.loadtxt(angles_file_list[i])
        N3 = N3_list[i]
